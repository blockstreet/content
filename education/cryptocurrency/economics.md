...
For most cryptocurrencies, there is a limited number of "coins" that are available at any given time. You can't just "create" a bitcoin out of nowhere and add it to your wallet. Coins are created by "miners" who are kind of like a government's mint. Miners can only create a limited number of coins in most cryptocurrencies, so the coins are a limited resource.
