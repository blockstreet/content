...
In 2008, a person (or group of people) under the name "Satoshi Nakamoto" released a paper describing a digital currency system controlled by every user of the system by using a "Blockchain". This paper spawned the first cryptocurrency "Bitcoin", and inspired for hundreds of other cryptocurrencies.
